...
class Meal {
  ...
  /**
   * Gut absorption rate for meal.
   * @param {number} A_G Carbohydrate bioavailability (unitless).
   * @param {number} t_max_G Time to maximum of carbohydrate absortion (min).
   * @return {number} Gut glucose absortion rate (mmol min^-1).
   */
